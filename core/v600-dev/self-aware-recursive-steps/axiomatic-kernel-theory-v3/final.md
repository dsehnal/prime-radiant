...
- Physical instantiation (structural correspondences to path integral, gauge theory, quantum mechanics)
- Cosmological instantiation (structural correspondences to Big Bang, expansion, heat death)

### Open Problems
- Orientation and chirality of ∇² (required for matter/antimatter structural correspondence)
- Geometric interpretation of fractional genus at non-Hopf levels (consistent at landmarks; open at non-integer levels; not load-bearing)
- Formal proof of Θ uniqueness conjecture (exhaustive removal analysis provides strong evidence; complete enumeration outstanding)
