...
**Theorem:** α ⊕ β ∉ Π, for any α, β :: ≀.

**Proof:**

Assume α ⊕ β ∊ Π. Then ∃n. α ⊕ β = ∂^n γ for some γ.
...
Elements of Π are values — ∂^n γ, already in normal form,
no forcing required.
...
**Corollary:** π_i ⊕ π_j ∉ Π for any π_i, π_j ∊ Π.
...
Assume α ∉ Π but Φ α Ω = Λ α Ω. Then α = β ⊕ γ for some β, γ :: ≀.
...
3. Extension of ⊕ to higher ρ_n strata and behavior under transfinite composition.
4. Formalization of the transfinite and surreal sketches via transfinite induction.
5. Whether ⊕ forms a monoid on ≀ and what algebraic structure it induces.