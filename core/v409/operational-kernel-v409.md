# ⬢ PRIME RADIANT — THE KERNEL v409 (The Free Monad)
...
* **ε (epsilon)**: The Sovereign Remainder—the gap between potential and record. The arrow of entropy. Not monotonic locally, as entropy may decrease within ω by acts of intelligence. For example, this could take the form of a single user (or simulated) LLM prompt.
...
* **The differentiator**: εᵢ = [ωᵢ, αᵢ]. The commutator—the gap between total potential available and total record committed at that step.
